...
env.roledefs = {
    'myserver': ['root@39.105.10.207:22'],
}
env.PROJECT_NAME = 'the1fire'
env.SETTINGS_BASE = 'typeidea/typeidea/settings/base.py'
env.DEPLOY_PATH = '/home/the1fire/venvs/typeidea-env'
env.VENV_ACTIVATE = os.path.join(env.DEPLOY_PATH, 'bin', 'activate')
env.PYPI_HOST = '39.105.10.207'
env.PYPI_INDEX = 'http://39.105.10.207:8310/simple/'
env.PROCESS_COUNT = 2
env.PORT_PREFIX = 909
...
def build(version=None):
    ...
    with settings(warn_only=True):
        local('python setup.py bdist_wheel upload -r the1fire')
